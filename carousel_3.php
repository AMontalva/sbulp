<?php 
    ...
    $result = find_and_store_all_content(22344 , 22351); 
    $act_array = find_category_content("act", 22344, 22416);
    $dance_array = find_category_content("dance", 22344, 22416);
    $design_array = find_category_content("design", 22344, 22416);
    $direct_array = find_category_content("direct", 22344, 22416);
    $manage_array = find_category_content("manage", 22344, 22416);
    $music_array = find_category_content("music", 22344, 22416);
    $produce_array = find_category_content("produce", 22344, 22416);
    $write_array = find_category_content("write", 22344, 22416);
...
<ul class="nav nav-tabs">
    <li role="presentation"><a data-toggle="tab" href="#all_tab3">All</a></li>
    <li role="presentation"><a data-toggle="tab" href="#act_tab3">Act</a></li>
    <li role="presentation"><a data-toggle="tab" href="#dance_tab3">Dance</a></li>
    <li role="presentation"><a data-toggle="tab" href="#design_tab3">Design</a></li>
    <li role="presentation"><a data-toggle="tab" href="#direct_tab3">Direct</a></li>
    <li role="presentation"><a data-toggle="tab" href="#manage_tab3">Manage</a></li>
    <li role="presentation"><a data-toggle="tab" href="#music_tab3">Music</a></li>
    <li role="presentation"><a data-toggle="tab" href="#produce_tab3">Produce</a></li>
    <li role="presentation"><a data-toggle="tab" href="#write_tab3">Write</a></li>
    <li role="presentation"><a data-toggle="tab" href="#paths_tab3">Paths</a></li>
</ul>


<!-- all content tab -->
<div class="tab-content">
    <div id="all_tab3" class="tab-pane in active fade">
...
<!-- act content tab -->
    <div id="act_tab3" class="tab-pane fade">
        <div class="single-item">
...
<!-- dance content tab -->
    <div id="dance_tab3" class="tab-pane fade">
        <div class="single-item">
...
<!-- design content tab -->
    <div id="design_tab3" class="tab-pane fade">
        <div class="single-item">
...
<!-- direct content tab -->
    <div id="direct_tab3" class="tab-pane fade">
        <div class="single-item">
...
<!-- manage content tab -->
    <div id="manage_tab3" class="tab-pane fade">
        <div class="single-item">
...
<!-- music content tab -->
    <div id="music_tab3" class="tab-pane fade">
        <div class="single-item">
...
<!-- produce content tab -->
    <div id="produce_tab3" class="tab-pane fade">
        <div class="single-item">
...
<!-- write content tab -->
    <div id="write_tab3" class="tab-pane fade">
        <div class="single-item">
...
<!-- paths content tab -->
    <div id="paths_tab3" class="tab-pane fade">
        <div class="single-item">
